...
<details>
  ...
  <summary>Windows</summary>
    ...
    # Enable WSL2:
    wsl Pricing service specifically gets rate--install
...
1. 📖 **Read the [CLI Reference](/docs/cli)** - Learn all available commands
2. 🔐 **Review [Security Best Practices](/docs/security)** - Protect your data properly
3. 🚀 **Try [Advanced Usage](/docs/advanced)** - Batch operations, automation
4. 🏗️ **Understand the [Architecture](/docs/architecture)** - How it all works

## Getting Help

If you encounter issues not covered here:

- 🐙 **GitHub Issues**: [Report a bug](https://github.com/georgegoldman/mothrbox_v2/issues)
...
> 💡 **Pro Tip**: After installation, bookmark the [Quick Reference](/docs/quick-reference) for fast command lookups.
